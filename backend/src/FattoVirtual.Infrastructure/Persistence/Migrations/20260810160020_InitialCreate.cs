        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsOrganizationOwner = table.Column<bool>(type: "boolean", nullable: false),
                    AssignedClientIds = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SupportWhatsAppUrl = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsOwnerType = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AccessTypes_Organizations_OrganizationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AgendaCategories_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppCatalogItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppCatalogItems_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChecklistTemplates_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FaqItems_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PartnerCompanies_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceItems_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrganizationId = table.Column<Guid>(type: "uuid", nullable: false),
                    Name = table.Column<string>(type: "text", nullable: false),
                    UsageDescription = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sops_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClientApps_AppCatalogItems_AppId",
                        column: x => x.AppId,
                        principalTable: "AppCatalogItems",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ClientApps_Clients_ClientId",
                        column: x => x.ClientId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OnboardingItems_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShareLinks_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ShareLinks_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TodoItems_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AgendaEvents_AgendaCategories_CategoryId",
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AgendaEvents_Employees_ResponsibleEmployeeId",
                        column: x => x.ResponsibleEmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AgendaEvents_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EmployeeScheduleDays_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SopScripts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SopScripts_Sops_SopId",
                        column: x => x.SopId,
                        principalTable: "Sops",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccessTypes_OrganizationId",
                table: "AccessTypes",
                column: "OrganizationId");

            migrationBuilder.CreateIndex(
                name: "IX_AgendaCategories_OrganizationId",
                table: "AgendaCategories",
                column: "OrganizationId");

            migrationBuilder.CreateIndex(
                name: "IX_AgendaEvents_CategoryId",
                table: "AgendaEvents",
                column: "CategoryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AgendaEvents_OrganizationId",
                table: "AgendaEvents",
                column: "OrganizationId");

            migrationBuilder.CreateIndex(
                name: "IX_AgendaEvents_ResponsibleEmployeeId",
                table: "AgendaEvents",
                column: "ResponsibleEmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_AppCatalogItems_OrganizationId",
                table: "AppCatalogItems",
                column: "OrganizationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeClients_EmployeeId_ClientId",
                table: "EmployeeClients",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeScheduleDays_EmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OnboardingItems_ClientId",
                table: "OnboardingItems",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_PartnerCompanies_OrganizationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceItems_OrganizationId",
                table: "ServiceItems",
                column: "OrganizationId");

            migrationBuilder.CreateIndex(
                name: "IX_ShareLinks_ClientId",
                table: "ShareLinks",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_ShareLinks_OrganizationId",
                table: "ShareLinks",
                column: "OrganizationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sops_OrganizationId",
                table: "Sops",
                column: "OrganizationId");

            migrationBuilder.CreateIndex(
                name: "IX_SopScripts_SopId",
                table: "SopScripts",
                column: "SopId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TodoItems_OrganizationId",
                table: "TodoItems",
                column: "OrganizationId");
        }
